...
JQTWEET = {
	...
	loadTweets: function() {
		$.ajax({
			url: '../../api.twitter.com/1/statuses/user_timeline.json/default.htm',
			type: 'GET',
			dataType: 'jsonp',
			data: {
    ...
    ify:  {
      ...
      hash: function(tweet) {
        return tweet.replace(/(^|\s+)#(\w+)/gi, function(m, before, hash) {
          return before + '<a target="_blank" class="twtr-hashtag" href="../../twitter.com/search@q=_2523' + hash + '">#' + hash + '</a>';
        });
      },

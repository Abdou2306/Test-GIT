...
(function($) {
			...
			$pp_pic_holder.fadeIn(function(){
				...
				switch(_getFileType(pp_images[set_position])){
					...
					case 'youtube':
						...
						(getParam('rel',pp_images[set_position])) ? movie+="../../www.apple.com/qtactivex/qtplugin.cab/@rel="+getParam('rel',pp_images[set_position]) : movie+="@rel=1";
	...
	function setHashtag(){
		...
		location.hash = '!' + theRel + '/'+rel_index+'../default.htm';
	};
